== README - preparing for heroku launch
  ...
  $ \copy registered_voter_histories (vtrid,election_date,election_description,election_type,political_party,election_code,voting_method,date_of_voting,precinct,early_voting_location,juristiction_code,county_name) from '/home/mark/Work/pboostv2/db/fixtures/Stinnie/StinnieHistory.txt' DELIMITERS E'\t' CSV HEADER ENCODING 'utf8';
