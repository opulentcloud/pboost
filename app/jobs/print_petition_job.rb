PPetitionJob = Struct.new(:voter_ids, :petition_header_id, :petition_header_circulator_id) do
...
class PrintPetitionJob < PPetitionJob
  ...
  def perform
    ...
    tempfile.write(CandidatePetitionFormReportPdf.new(petition_header_id, petition_header_circulator_id, voter_ids).render.force_encoding("UTF-8"))
